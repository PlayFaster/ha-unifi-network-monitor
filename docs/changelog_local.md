# Changelog - Local Detailed

All changes to the UniFi Network Monitor project will be documented in this file. This is the detailed changelog, to include non user facing changes and intra-release changes.
